  ...
  conn
    .on("ready", () => {
      conn.sftp((err, sftp) => {
        ...
        // console.log("Bug fix process is starting...getting FTP file");
        ...
        sftp.fastGet(moveFrom, moveTo, {}, (downloadErr) => {
          ...
          co(function* () {
            logger.info({
              ...
              type: "START",
              message: "Deleting numbers from Dynamo DB",
            });
            console.log("beginning number deletions...");
            try {
              ...
              console.log(`${error} - Error deleting ${del}`);
            }

            console.log("deletions should be finished...");
            logger.info({
              event: `Adding ${additions.length} records`,
              type: "START",
              message: "Adding numbers to Dynamo DB",
            });
            console.log("beginning number additions...");
            ...
            try {
              ...
              console.log(`${error} - Error adding ${add}`);
            }

            console.log("adding and deleting should be finished...");
            console.log("should now upload to s3 bucket...");
